...
{
    [SerializeField] List<RectTransform> selectableOptions;
    [SerializeField] RectTransform selectIndicator;
    ...
    [SerializeField] AudioClip scrollAudioClip;
    [SerializeField] AudioClip confirmAudioClip;

    [SerializeField] bool playUIShowAudio;

    [Header("Localization")]
    [SerializeField] TextAsset description_EN;
    [SerializeField] TextAsset description_KR;

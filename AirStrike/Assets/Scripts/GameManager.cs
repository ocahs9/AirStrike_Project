...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] AircraftController aircraftController;
    [SerializeField] PlayerAircraft playerAircraft;
    [SerializeField] CameraController cameraController;
    [SerializeField] TargetController targetController;
    [SerializeField] WeaponController weaponController;
    [SerializeField] GamepadController gamepadController;
    ...
    [SerializeField] List<GameObject> hideOnPause;
    ...
    [SerializeField] PauseController gameOverController;

    [SerializeField] List<GameObject> disableOnShowGameOverUI;

    bool isGameOver = false;
    
    [SerializeField] UnityEvent executeOnGameOver;
    [SerializeField] List<GameObject> disableOnGameOver;
    [SerializeField] List<GameObject> disableOnGameOverObjects;
    [SerializeField] List<GameObject> enableOnGameOverObjects;

    [SerializeField] DeathCam deathCam;
